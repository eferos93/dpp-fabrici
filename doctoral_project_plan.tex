...
There are four main approaches for guaranteeing privacy, which may also be used together (hybrid solutions) in RL: cryptographic protocol and Secure Multiparty Computation (SMC), differential privacy, masching and generalization techniques (e.g. k-anonimity). 
...
A line of research that aims to improve security while guaranteeing privacy consist in a series of work that use embedding techniques with or without differential privacy.
