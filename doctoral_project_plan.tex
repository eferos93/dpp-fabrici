...
\begin{enumerate}
   \item \textbf{Schema alignment}, a process that takes as input a set of different schemas on the same domain an outputs a \textit{mediated schema}, an \textit{attribute matching} and a \textit{schema mapping} \cite*{Dong2013}.
...
been used extensively \cite{Khurram2020,Vatsalan2017, Clifton, Kuzu2013, Gkoulalas-Divanis2021,Nobrega2021}.
