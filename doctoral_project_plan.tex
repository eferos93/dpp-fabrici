...
Research on data integration started more than 50 years ago \cite*{recordLinkTheory,dataModelIntegration1980} but as we entered in the Big Data era, new challanges arose, 
both in the problem of scaling \cite*{Dong2013} data integration while guaranteeing the privacy \cite*{yu2016big} of the individuals.

Over the last decade new techniques have been applied for improving computational performances, which consist in the use of summarization techniques for computing approximate
answers \cite*{Cormode2011} and  
