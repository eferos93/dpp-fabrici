...
have an unified view. The premise of data integration is to make data more freely available and easier 
to consume and process by systems and users.

Research on data integration started more than 50 years ago \cite*{recordLinkTheory,dataModelIntegration1980} but with the advent of the big data era 
new challenges arose, both in the problem of scaling \cite*{Dong2013} data processing and guaranteeing privacy \cite{yu2016big}.
